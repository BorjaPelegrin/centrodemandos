...
<li class="dropdown user user-menu">
    ...
    <ul class="dropdown-menu">
        ...
        <li class="user-header">
            ...
            <p>
                Nombre <?php /* <?= Yii::$app->user->identity->clinicEmployee->employeeName ?> */ ?>
        ...
        <li class="user-body">
            <div class="row">
                <div class="col-xs-12 text-center">
                    boton "clínica"
                    <?php /* <?= Html::a($clinic->id_clinic.': '.$clinic->name, ['/clinic/clinic/view', 'id'=>$clinic->id_clinic], ['class'=>'btn btn-primary btn-block btn-flat']) ?> */ ?>
                </div>
            </div>
            <!-- /.row -->
        </li>
